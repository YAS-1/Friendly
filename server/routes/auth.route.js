...
import { createAccount, getCurrentUserProfile, getUserProfile, login, logout, updateUserProfile } from '../controllers/auth.controller';
...
authRoute.get('/userProfile/:UserId', protectRoute, getUserProfile);
