...
const Sidebar = () => {
	...
	return (
		<div className='fixed h-screen w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4 flex flex-col'>
			...
			<button
				onClick={logout}
				className='w-full flex items-center gap-3 px-4 py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors mb-4'>
				<FiLogOut size={20} />
				<span>Logout</span>
			</button>
